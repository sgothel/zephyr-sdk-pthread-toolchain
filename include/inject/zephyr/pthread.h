...
/**
 * Zephyr compatible all-in-one pthread.h, validated against `arm-zephyr-eabi`.
 *
 * Based on the used Zephyr includes and used `int` types (only),
 * we can assume that the Zephyr used pthread types are architecture independent.
 */
...
///////////////////////////////////////////////////////
// ${ZEPHYR_SDK_INSTALL_DIR}/gnu/arm-zephyr-eabi/arm-zephyr-eabi/sys-include/sys/_types.h
///////////////////////////////////////////////////////
...
/////////////////////////////////////////////////
// ${ZEPHYR_BASE}/lib/libc/picolibc/include/time.h
/////////////////////////////////////////////////
...
///////////////////////////////////////////////////////
// ${ZEPHYR_BASE}/include/zephyr/posix/posix_types.h
///////////////////////////////////////////////////////
...
typedef struct { /* total bytes: 8 + sizeof(void*) = 12 bytes w/ void* = 32-bit */
    void *stack;
    uint32_t details[2]; /* ensure 8-bytes */
} pthread_attr_t;
...
/////////////////////////////////////////////////
// ${ZEPHYR_BASE}/include/zephyr/posix/sched.h
/////////////////////////////////////////////////
...
/////////////////////////////////////////////////
// ${ZEPHYR_BASE}/include/zephyr/posix/pthread.h
/////////////////////////////////////////////////
...
int pthread_once(pthread_once_t *once, void (*initFunc)());
#endif
